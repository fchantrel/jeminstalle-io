...
public class ProDAOImpl implements ProDAO {
    ...
    public String findByCoordonneesAndRubrique(String latitude, String longitude, String rubrique, String distanceKM, String maxResultat) {
        ...
        String retour = restTemplate.getForObject("http://localhost:9200/slev8epj/blocsepj/_search?size=" + maxResultat, String.class, s);
        return retour;
    }
	...
	public int findByCommuneAndActivite(String commune, String activite, String maxResultat) {
		...
		try{
			retour = restTemplate.postForObject("http://localhost:9200/slev8epj/blocsepj/_count", s, DenombrementES.class);
	    } catch(Exception e){
